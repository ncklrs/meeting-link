...
export function OptInBanner() {
  ...
  return (
    <>
      <div className="fixed inset-x-0 bottom-0 z-50 bg-secondaryAccent/70">
        <div className="relative isolate flex items-center gap-x-6 overflow-hidden px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
          ...
          >
            <div
              ...
              className="aspect-[577/310] w-[36.0625rem] bg-secondaryAccent opacity-50"
            />
          </div>
          <div
            aria-hidden="true"
          ...
          <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
            ...
            {!isSubmitted && (
              <Button
                className="bg-primaryAccent text-white font-bold"
                onClick={() => {
              ...
              >
                Sign the manifesto <span aria-hidden="true">&rarr;</span>
              </Button>
            )}
          </div>
